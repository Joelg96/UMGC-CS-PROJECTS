 ...
 * 2/6/23
 * CMSC 330 Project 1 
 * This class parses desired input file to create a scene. users the lexer to get next token. 
 */
...
class Parser {
    ...
    // JG added  Additional handlers added for the project
        // added - TEXT - Handles the text
        ...
        // JG Added - ISOSCELES TRIANGLE - Handles the isosceles triangle
        ...
        // JG Added - PARALLELOGRAM - Handles the parallelogram
        ...
        // JG Added - REGULAR POLYGON - Handles the regular polygon
    ...
    // Return an array of the numbers in the number list
